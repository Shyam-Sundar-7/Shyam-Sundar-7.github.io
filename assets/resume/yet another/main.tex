...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\namesection{Shyam Sundar}
{\urlstyle{same}
	\faEnvelope \href{mailto:mailshyamsundar.2022@gmail.com}{mailshyamsundar.2022@gmail.com}\\
...
\subsection{Defence Institute of Advanced Technology}
% \descript{Tandon School of Engineering}
M.Tech in Modelling and Simulation\\
7.95 GPA ,May \textbf{2023 } | Pune,IN\\
% Cum. GPA: 4.0\\
\sectionsep

\subsection{National Institute of Technology}
B.Tech in Chemical Engineering\\
7.65 GPA ,May \textbf{2021 } | Tiruchirappalli,IN\\
\sectionsep
